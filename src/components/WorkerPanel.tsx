...
export default function WorkerPanel({
  ...
  const estimatedPayment = Math.round((settings.weeklyPaymentCOP * complianceRate) / 100);
  ...
  const triggerWhatsAppRedirect = (task: Task) => {
    ...
    openWhatsAppBusinessLink(settings.adminWhatsApp, text);
  };
                            ...
                            {(selectedTask.status === 'EN_PROCESO' || selectedTask.status === 'RECHAZADA') && (
                              <div className="space-y-2">
                                ...
                                >
                                  ...
                                  <span>Entregar para Revisión (Abre WhatsApp)</span>
                                </button>
                              </div>
                            )}
